...
Closed-loop AI revenue recovery decision engine.

Pipeline:
    Payment Context
        ↓
    Action-conditioned CatBoost
        ↓
    ...
    SHAP Explanation
        ↓
    Deterministic Demo Outcome
        ↓
    Feedback Metadata

IMPORTANT
---------
The model is action-conditioned.

It was trained with these 20 features:
...
Therefore, every candidate action is evaluated by setting
observed_intervention to that action.
